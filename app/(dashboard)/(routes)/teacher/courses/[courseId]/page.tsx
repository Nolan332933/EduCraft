...
import { AttahmentForm } from "./_components/attachment-form";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex items-center gap-x-2">
              <IconBadge icon={File} />
              <h2 className="text-2xl">Resources & Attachments</h2>
            </div>
            <AttahmentForm initialData={course} courseId={course.id} />
          </div>
        </div>
      </div>
    </div>
